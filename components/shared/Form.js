          ...
          <div className="flex-auto p-5 lg:p-10">
            ...
            <form name="contact-form" method="POST" action="./#contact?success=true" data-netlify="true" data-netlify-honeypot="bot-field">
              ...
              <div className="mt-8">
                ...
                <div className="relative w-full mb-3">
                  <label className="block uppercase text-blueGray-500 text-xs font-bold mb-2 ml-1">Link</label>
                  {links.map((l, index) => (
                    <div key={index} className="relative flex w-full flex-wrap items-stretch mb-3">
                      ...
                      />
                      <span
                        className="cursor-pointer z-10 h-full flex absolute text-center text-red-900 text-sm items-center w-8 right-0"
                        onClick={() => {
